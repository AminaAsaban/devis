...
<?php
    ...
    if (isset($_POST['sign-up'])) {
        ...
        if (!empty($email) && !empty($pwd)) {
            $sqlState = $pdo->prepare('INSERT INTO utilisateur (name, username, email, password) VALUES (?, ?, ?, ?)');
            $sqlState->execute([$name, $user, $email, $pwd]);
            // Redirection
...
?>
    ...
    <form class="user" action="sign-up.php" method="post">
                                            ...
                                            <div class="card-body">
                                                <div class="edit-profile__body">
                                                    ...
                                                    <div class="button-group d-flex pt-1 justify-content-md-start justify-content-center">
                                                        <button type="submit" class="btn btn-primary btn-default btn-squared mr-15 text-capitalize lh-normal px-50 py-15 signUp-createBtn signIn-createBtn" name="sign-up">
                                                            Create Account
                                                        </button>
                                                    </div>
